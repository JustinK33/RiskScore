...
`pytest -q` passes 704 tests with 3 skipped, at 96.6% line and branch coverage.
...
- Verified with 704 Python tests at 96.6% coverage, 104 JavaScript tests, strict mypy, ruff, and a CI end-to-end smoke job that boots the service and asserts every documented artifact exists.
